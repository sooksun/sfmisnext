---
name: "source-command-release-readiness"
description: "ประเมินความพร้อมก่อน deploy production — env, migration, monitoring, rollback"
---

# source-command-release-readiness

Use this skill when the user asks to run the migrated source command `release-readiness`.
