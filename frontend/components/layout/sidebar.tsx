...
const navGroups: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: '1.4 ตั้งค่าประเภทเงินรายหัว', href: '/sfmis/perhead-rate-config',         icon: ListOrdered,   roles: PLAN },
      { label: '1.5 กำหนดอัตราเงินต่อหัว',    href: '/sfmis/perhead-rate-setting',        icon: TrendingUp,    roles: PLAN },
      { label: '1.6 คำนวณงบจากรายหัว',        href: '/sfmis/calculate-perhead',           icon: Calculator,    roles: PLAN },
      { label: '1.7 งบประมาณรวมรายปี',        href: '/sfmis/estimate-acadyear',           icon: CalendarRange, roles: PLAN },
      { label: '1.8 กำหนดวงเงินงบประมาณ',     href: '/sfmis/budget-category',             icon: Layers,        roles: PLAN },
      { label: '1.9 แผนงาน/โครงการ',          href: '/sfmis/plan-menu/project',           icon: FolderOpen,    roles: [...PLAN, 4, 7] },
      { label: '1.10 บริหารโครงการ',          href: '/sfmis/plan-menu/manage-project',    icon: Boxes,         roles: [...PLAN, 4, 7] },
      { label: '1.11 อนุมัติโครงการ',         href: '/sfmis/plan-menu/proj-approve',      icon: CheckSquare,   roles: [...PLAN, 4, 7] },
      { label: '1.12 แผนจัดซื้อจัดจ้าง',      href: '/sfmis/plan-menu/procurement-plan',  icon: ClipboardList, roles: [...PLAN, 4, 7] },
      { label: '1.13 ติดตามแผน-โครงการ',      href: '/sfmis/plan-menu/plan-trace',        icon: GitBranch,     roles: PLAN },
  ...
  },
  {
    ...
    children: [
      ...
      { label: '2.3 เอกสารจัดซื้อ/ตรวจรับ', href: '/sfmis/supplie-setting/procurement-docs', icon: BadgeCheck, roles: SUPPLY },
      { label: '2.4 สัญญา/ส่งมอบ',        href: '/sfmis/supplie-setting/contract',    icon: FileText,    roles: SUPPLY },
      { label: '2.5 รับพัสดุ',            href: '/sfmis/receive-parcel',               icon: Truck,       roles: SUPPLY },
      { label: '2.6 ยืนยันรับพัสดุ',      href: '/sfmis/receive-parcel-confirm',        icon: PackageCheck, roles: SUPPLY },
      { label: '2.7 บัญชีวัสดุ',          href: '/sfmis/supplies',                    icon: Boxes,       roles: SUPPLY },
      { label: '2.8 เบิกพัสดุ/ใบเบิก',    href: '/sfmis/supplie-setting/requisition',   icon: ClipboardSignature, roles: SUPPLY },
      { label: '2.9 ตรวจสอบ/จำหน่ายประจำปี', href: '/sfmis/supplie-setting/annual-check', icon: ShieldCheck, roles: SUPPLY },
