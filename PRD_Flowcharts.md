...
> ⚠️ **หมายเหตุสถานะจริง (มิ.ย. 2569):** flowchart ในไฟล์นี้ครอบ **กระบวนการหลักของ 21 โมดูล core** Repo จริงมี workflow เพิ่มที่ยังไม่ได้วาดไว้ที่นี่ — เช่น เงินยืม (สัญญายืมเงิน: ตรวจ→อนุมัติ→รับเงิน→ส่งใช้), ค่าเดินทาง (แบบ 8708), งบเทียบยอดธนาคาร, ทะเบียนคุมตามระเบียบกรมบัญชีกลาง (G1–G17). status/state transition จริงให้ยึดจาก service จริงในแต่ละโมดูล. แหล่งสถานะรวม: `plan.md` + `CLAUDE.md`
