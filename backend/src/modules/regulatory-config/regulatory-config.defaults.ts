...
export const REGULATORY_DEFAULTS: RegulatoryDefault[] = [
  ...
  {
    key: 'procurement.enforce_committee_separation',
    value: 1,
    unit: '0/1',
    group: 'procurement',
    label:
      'บังคับแยกหน้าที่กรรมการตรวจรับ (1=บังคับ, 0=ปิด) — กรรมการตรวจรับต้องไม่ซ้ำกัน และต้องไม่ใช่ผู้จัดทำ/ผู้ขอซื้อรายการเดียวกัน',
    lawRef: 'พ.ร.บ.จัดซื้อจัดจ้างฯ 2560 ม.13 (ผู้มีหน้าที่ต้องไม่เป็นผู้มีส่วนได้เสีย)',
  },
  {
    key: 'procurement.block_contract_over_order',
    value: 1,
    unit: '0/1',
    group: 'procurement',
    label:
      'บล็อกการทำสัญญาเกินวงเงินคำสั่งซื้อ (1=บล็อก, 0=ปิด) — มูลค่าสัญญาห้ามเกินวงเงินที่อนุมัติจัดหา',
  ...
  // ── การ์ดเชื่อมโยงข้ามงาน (Cross-domain guards) ────────────────────────
  // กฎตรวจความขัดแย้งที่ลามจากงานนโยบาย/แผน → พัสดุ → การเงิน
  {
    key: 'finance.block_project_overcommit',
    value: 1,
    unit: '0/1',
    group: 'finance',
    label:
      'บล็อกการก่อหนี้จัดซื้อรวมเกินวงเงินโครงการ (1=บล็อก, 0=ปิด) — ผลรวมคำสั่งซื้อของโครงการห้ามเกินงบโครงการที่อนุมัติ',
    lawRef: 'ระบบการควบคุมเงินของหน่วยงานย่อย พ.ศ. 2544',
  },
  {
    key: 'finance.block_pay_before_inspection',
    value: 1,
    unit: '0/1',
    group: 'finance',
    label:
      'บล็อกการตั้งเบิกก่อนตรวจรับพัสดุครบ (1=บล็อก, 0=ปิด) — เบิกได้เมื่อตรวจรับผ่านและลงบัญชีพัสดุแล้ว',
    lawRef: 'ระเบียบกระทรวงการคลังว่าด้วยการเบิกเงินจากคลังฯ 2562',
  },
  {
    key: 'finance.warn_year_mismatch',
    value: 1,
    unit: '0/1',
    group: 'finance',
    label:
      'เตือนเมื่อปีงบประมาณไม่สอดคล้องกันข้ามเอกสาร (1=เตือน, 0=ปิด) — โครงการ/คำสั่งซื้อ/ใบเบิกควรเป็นปีงบเดียวกัน',
    lawRef: 'แนวการประเมินฯ กลุ่มตรวจสอบภายใน สพฐ.',
  },
  {
    key: 'finance.warn_inactive_bgtype',
    value: 1,
    unit: '0/1',
    group: 'finance',
    label:
      'เตือนเมื่ออ้างอิงประเภทเงิน/หมวดงบที่ไม่ได้เปิดใช้ในปีนั้น (1=เตือน, 0=ปิด)',
    lawRef: 'ระบบการควบคุมเงินของหน่วยงานย่อย พ.ศ. 2544',
  },
];
