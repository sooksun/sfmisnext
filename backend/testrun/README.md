...
> `reset-2569.sql` ตั้ง per-school config `finance.wht_min=0` (sc_id=1) → ระบบหักภาษี
> **ทุกครั้ง**ที่จ่ายให้ผู้ขายที่ตั้ง `cal_vat` 0/1 (ปรับกลับเป็นเกณฑ์ 10,000 ได้ที่หน้าตั้งค่าโรงเรียน)
